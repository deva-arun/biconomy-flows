...
export function SessionUAPMultiStepBenchmark4() {
    ...
    const grantPermission = async () => {
        ...
        try {
            addLog('Permission 4: Usage Limit (Max 3 Transactions)');

            const usageLimitPolicy = getUsageLimitPolicy({ limit: 3n });
            ...
            const details = await meeClient.grantPermissionTypedDataSign({
                ...
                actions: [{
                    ...
                    actionPolicies: [usageLimitPolicy]
                }],
                maxPaymentAmount: parseUnits('1', 6)
            });

            addLog('Permission Granted! Max 3 uses.');
    ...
    const executeTransfer = async () => {
        ...
        try {
            ...
            addExecLog('Error (Expected if > 3 uses):', err);
        } finally {
            setExecuting(false);
        }
    };
    ...
    return (
        <BenchmarkContainer small bordered>
            <h2>Permission 4: Usage Limit (Max 3)</h2>
            <BenchmarkButton
