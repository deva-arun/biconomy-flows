...
export function SessionUAPMultiStepBenchmark5() {
    ...
    const grantPermission = async () => {
        ...
        try {
            addLog('Permission 5: UAP + 5 Minute Time Limit');
            ...
            const details = await meeClient.grantPermissionTypedDataSign({
                ...
                actions: [{
                    ...
                    actionPolicies: [uapPolicy, timeFramePolicy]
                }],
                maxPaymentAmount: parseUnits('1', 6)
            });

            addLog('Permission Granted! Exports in 5 minutes.');
    ...
    return (
        <BenchmarkContainer small bordered>
            <h2>Permission 5: UAP + 5 Min Limit</h2>
            <BenchmarkButton
