...
export function SessionUAPMultiStepBenchmark1() {
    ...
    const grantPermission = async () => {
        ...
        try {
            addLog('Permission 1: UAP 10 USDC Limit (Cumulative)');

            const maxTransferAmount = parseUnits('1', 6);
            addLog(`Max Cumulative Amount: ${maxTransferAmount}`);
                    ...
                    rules: [
                        {
                            ...
                            isLimited: true,
                            offset: 32n,
                            ref: pad(toHex(maxTransferAmount)),
                            usage: { limit: maxTransferAmount, used: 0n }
                        },
    ...
    const executeTransfer = async () => {
        ...
        try {
            ...
            const transferAmount = parseUnits('45', 4); // 0.75 USDC
                ...
                instructions: [{
                    calls: [{
                        ...
                        data: encodeFunctionData({
                            ...
                            args: [sessionSigner.address, transferAmount]
                        })
                    }],
                    chainId: base.id
                }]
    ...
    return (
        <BenchmarkContainer small bordered>
            <h2>Permission 1: UAP 10 USDC Limit</h2>
            <BenchmarkButton
